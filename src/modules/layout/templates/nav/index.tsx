...
//           {/* Right - Navigation Links (Responsive) */}
//           <div className="flex items-center gap-2 sm:gap-4 lg:gap-6">
            
//             {/* Desktop Navigation - Hidden on Mobile/Tablet */}
//             <div className="hidden xl:flex items-center gap-4">
//               <LocalizedClientLink
//                 className="group relative py-2 px-3 rounded-lg text-gray-700 hover:text-blue-600 font-medium transition-all duration-200 hover:bg-blue-50 text-sm"
//                 href="/customerlist"
//                 data-testid="nav-customer-link"
//               >
...
//               {/* Wishlist Button - Hidden on smallest screens */}
//               <button className="hidden sm:block group relative p-2 sm:p-3 rounded-lg sm:rounded-xl bg-gray-50 hover:bg-red-50 border border-gray-200 hover:border-red-200 transition-all duration-200 transform hover:scale-105">
...
//                     <span className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-4 h-4 sm:w-5 sm:h-5 bg-blue-500 text-white text-xs rounded-full flex items-center justify-center font-medium">
//                       0
//                     </span>
//                   </div>
//                 }
...
//               {/* User Account Button - Responsive */}
//               <LocalizedClientLink
//                 href="/account"
...
//       <div className="xl:hidden bg-white border-t border-gray-200 px-2 py-3 shadow-lg">
//         <div className="flex items-center justify-around max-w-md mx-auto">
//           <LocalizedClientLink 
//             href="/store" 
//             className="flex flex-col items-center gap-1 p-3 text-gray-600 hover:text-blue-600 transition-all duration-200 rounded-lg hover:bg-blue-50 min-w-0"
//           >
//             <FiShoppingBag className="w-5 h-5" />
  ...
  <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent" />
      ...
      {/* <div className="hidden sm:block xl:hidden bg-white border-t border-gray-200 px-2 py-3 shadow-lg">
        <div className="flex items-center justify-around max-w-lg mx-auto">
          <LocalizedClientLink 
            href="/store" 
            className="flex flex-col items-center gap-1 p-3 text-gray-600 hover:text-blue-600 transition-all duration-200 rounded-lg hover:bg-blue-50 min-w-0 flex-1"
          >
            <FiShoppingBag className="w-5 h-5" />
            <span className="text-xs font-medium">Store</span>
          </LocalizedClientLink>
